...
export default function ProfilePage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const value = collectionData.reduce(
        (total: number, item: CollectionItem) => {
      ...
      <div className="bg-[#fafafa] py-6">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <section className="mb-10">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link
                href="/profile/collection"
                className="text-[#d14124] hover:text-[#b93a20] transition flex items-center gap-1 text-sm font-medium"
              >
                <span>View all</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {collection.length > 0 ? (
              ...
              <div className="bg-white border border-dashed border-[#e5e5e5] rounded-xl p-10 text-center">
                ...
                <p className="text-[#737373] max-w-md mx-auto mb-6">
                  Start building your sneaker collection by searching for your
                  favorite kicks and adding them.
                </p>
                <Link
                  href="/search"
            ...
            {wishlist.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {wishlist.slice(0, 4).map((item) => (
                  <div
                    key={item.id}
                    className="bg-white rounded-xl overflow-hidden shadow-sm border border-[#f0f0f0] hover:shadow-md transition-shadow relative group"
                  >
              ...
              <div className="bg-white border border-dashed border-[#e5e5e5] rounded-xl p-10 text-center">
                ...
                <p className="text-[#737373] max-w-md mx-auto mb-6">
                  Add sneakers to your wishlist while browsing to keep track of
                  what you want to buy next.
                </p>
                <Link
                  href="/search"
                  className="inline-flex items-center justify-center px-6 py-3 bg-[#d14124] text-white rounded-lg hover:bg-[#b93a20] transition shadow-sm"
        ...
        {showDeleteConfirmation && (
          <ConfirmationModal
            ...
            confirmLabel="Remove"
            onConfirm={() =>
              confirmRemoveFromCollection(showDeleteConfirmation)
            }
