      ...
      <main className="flex-grow flex flex-col">
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-3/5 mb-10 md:mb-0 md:pr-12 text-center md:text-left">
                ...
                <p className="text-lg text-[#737373] mb-8 leading-relaxed">
                  Track your sneaker collection, discover new releases, and
                  connect with fellow enthusiasts. The ultimate platform for
                  sneakerheads to manage their collections.
                </p>
        ...
        <section className="py-12 px-8 bg-white">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-center text-[#171717] mb-12">
              Key Features
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-6 bg-[#fafafa] rounded-xl border border-[#f0f0f0] hover:shadow-md transition-shadow">
                ...
                <p className="text-[#737373]">
                  Track your sneaker collection with detailed information
                  including condition, purchase details and other useful labels.
                </p>
              </div>
              ...
              <div className="p-6 bg-[#fafafa] rounded-xl border border-[#f0f0f0] hover:shadow-md transition-shadow">
                ...
                <p className="text-[#737373]">
                  Stay updated with news, trends, and guides from the sneaker
              ...
              <div className="p-6 bg-[#fafafa] rounded-xl border border-[#f0f0f0] hover:shadow-md transition-shadow">
                ...
                <p className="text-[#737373]">
                  Save sneakers you want to purchase in the future and keep
                  track of your most wanted items.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-8 bg-gradient-to-r from-[#fae5e1] to-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#737373] mb-8">
              Join SoleUp today and take your sneaker collection to the next
              level.
            </p>
      ...
      <footer className="py-8 px-8 border-t border-[#f0f0f0] bg-white">
        <div className="max-w-5xl mx-auto flex flex-col items-center">
          <p className="text-[#737373] text-sm">
            SoleUp &copy; {new Date().getFullYear()}
          </p>
        </div>
      </footer>
    </div>
